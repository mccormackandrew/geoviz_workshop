...
ggplot(rd_df[rd_df$region == "Montréal", ], 
       aes(long, lat, group = group, fill = mother_tongue_english)) +
  geom_polygon() +
  coord_fixed() +
  theme_void() +
  scale_fill_viridis_c()
...
There are a number of packages in R that offer powerful tools for creating interactive maps. We will focus on one of the most powerful and user-friendly of these packages---`leaflet`. Leaflet is a Javascript library for interactive maps which can be used in R with the `leaflet` package.
